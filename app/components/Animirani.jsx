...
var Animirani = React.createClass({
    ...
    componentWillMount: function() {
        ...
        var arr = [];
        // Checking if there is a word Animirani inside the zanrovi properties. If there is we push it to array arr. At the end we set the state.
        for(var i=0; i<movies.length; i++) {
            var zanr = movies[i].zanrovi;
            if(zanr.indexOf("Animirani") >=0) {
                arr.push(movies[i]);
            }
            this.setState({
                list: arr
